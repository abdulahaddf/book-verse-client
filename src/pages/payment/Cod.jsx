...
const Cod = () => {
    return (
        <div className="h-[70vh] w-11/12 md:w-1/2 mx-auto  md:p-10 text-center my-10 space-y-4 border-2 border-red shadow-2xl">
            <img className="w-32 mx-auto" src="https://i.ibb.co/PYJ6bm1/paid.png" alt="" />
            <h1 className="text-4xl">Congratulations! You&apos;ve placed the order</h1>
