...
{errors.receive && <span className="error font-light text-xs">Pick up information is required</span>}
                ...
                {errors.name && <span className="error font-light text-xs">Please fill your Name</span>}
                <div className="mb-2">
                  <label
                    htmlFor="phoneNumber"
                    className="block text-sm font-semibold text-gray-800"
                ...
                {errors.phoneNumber && <span className="error font-light text-xs">Please Enter your Phone Number</span>}
                ...
                {errors.address && <span className="error font-light text-xs">Please give Delivery address</span>}
      ...
      <div className="w-1/2 mx-auto my-5  bg-slate-200 py-10 rounded-lg ">
        ...
        <div className="flex flex-col items-center justify-center gap-10  ">
          ...
          <label className="flex items-center text-lg bg-white w-11/12 p-2 rounded-lg">
            ...
            <span className="">
              <img
                className=" mx-auto border-[5px] rounded-[10px]"
