...
const UserChat = () => {
  ...
  return (
    <div className="p-5">
      <div className="flex-1 justify-between flex flex-col h-[450px] md:h-[600px] rounded-2xl lg:max-w-[800px] md:mx-auto mt-0 bg-slate-300 my-5 md:pt-0 ">
        ...
        <div className="flex items-center sm:gap-10 justify-between sm:justify-start p-3 bg-gradient-to-r rounded-t-2xl from-[#82bdd2] from-80% to-cyan-500">
          ...
          <div>
            <h2 className="md:text-4xl text-xl font-mono font-bold text-slate-100">
              Chat Support <HiOutlineChatBubbleLeftRight className="inline mx-1"/>
            </h2>
            <h2 className="leading-none inline-block text-slate-100">We are here to Chat! </h2>
        ...
        <div className="border-t-2 border-gray-200 px-4 p-4 mb-2 sm:mb-0">
          <form onSubmit={buttonHandler} className="relative flex items-center gap-5">
