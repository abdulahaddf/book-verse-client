...
const Navbar = () => {
  ...
  const { addToCartData, user, logOut, darkMode, setDarkMode } =
    ...
    <>
      <li className="my-8">
        <div
          className={` ${
            darkMode
              ? 'hover:text-[#10aade]  hover:no-underline text-base font-bold flex justify-between'
              : 'hover:no-underline text-base font-bold flex justify-between'
          } `}
        >
          {user ? (
            <div className="flex justify-center items-center">
              ...
              <span
                className={` ${
                  darkMode
                    ? 'hover:text-[#10aade]  hover:no-underline text-base font-bold ml-3'
                    : 'hover:no-underline text-base font-bold ml-3'
                } `}
              >
                {user?.displayName}
              </span>
            ...
            <Link
              ...
              className={
                darkMode
                  ? 'btn bg-black/0 text-white btn-sm normal-case ps-5 pe-0 rounded-3xl hover:no-underline hover:text-cyan-700'
                  : 'btn bg-[#10aade] text-white btn-sm normal-case ps-5 pe-0 rounded-3xl hover:no-underline hover:text-cyan-700'
              }
            >
              ...
              <span className="rounded-full p-1 bg-white">
                <FaSignOutAlt
                  className={
                    darkMode
                      ? 'bg-white text-[#10aade] text-xl rounded-full'
                      : 'bg-white text-[#10aade] text-xl rounded-full'
                  }
                />
              </span>
      ...
      <li className=" text-base font-bold ">
        <NavLink
          className={` ${
            darkMode
              ? 'hover:text-[#10aade]  hover:no-underline text-base font-bold'
              : 'hover:no-underline text-base font-bold'
          } `}
          to="/"
        >
  ...
  return (
    ...
    >
      <div
        className={` z-50 ${darkMode ? 'bg-[#131313]' : 'bg-white'} shadow-sm`}
      >
        <div
          className={`navbar  ${
            darkMode ? 'bg-[#131313]' : 'bg-base-100'
          }  w-11/12 md:w-11/12 mx-auto  lg:w-11/12 xl:w-11/12  inset-0 z-20 sticky`}
        >
            ...
            <div className="drawer lg:hidden z-20 w-7 relative ">
              ...
              <div className="drawer-side ">
                ...
                <ul
                  className={
                    darkMode
                      ? 'menu p-4 w-80 h-full  bg-[#2B2B2B] border-[1px] text-base-content'
                ...
                >
                  <div className="flex ">
                    <Link to="/">
                      {darkMode ? (
                        <img
                          className="w-[99px] h-[30px] lg:w-[200px] lg:h-[50px] sm:mx-auto"
                          src={darkLogo}
                          alt=""
                        />
                      ) : (
                        <img
                          className="w-[99px] h-[30px] lg:w-[200px] lg:h-[50px] "
                          src={logo}
                          alt=""
                        />
                      )}
                ...
                <div className="  mx-auto ">
                  <Link to="/">
                    {darkMode ? (
                      ...
                      <img
                        className="w-4/5 h-[30px] lg:w-[200px] lg:h-[50px] ml-5 md:ml-0"
                        src={logo}
                        alt=""
                      />
                    )}
          ...
          <div className="navbar-end ">
            ...
            {user ? (
              ...
              >
                <label
                  tabIndex={0}
                  className="cursor-pointer flex border rounded-lg p-1  justify-center items-center overflow-hidden "
                >
                  {' '}
                  <div className="flex items-center">
                    <img
                      className="w-[30px] rounded-full mr-1 sm:w-[28px]"
                      src={user?.photoURL}
                    />
                ...
                <ul
                  ...
                  className={`dropdown-content z-[1]  menu p-2 shadow ${
                    darkMode === true
                      ? ' bg-black 90 text-white   w-32 md:w-40 lg:w-40 '
                      : 'bg-base-100'
                  } rounded-box  w-32 md:w-40 lg:w-40  `}
                >
                  <li>
                    <Link
                      to="/dashboard/userHome"
                      className={`${
                        darkMode
                          ? 'hover:text-[#10aade]  hover:no-underline'
                          : 'justify-between hover:no-underline hover:text-[#10aade] '
                      }`}
                    >
                      My Profile
                      <span className=""></span>
                      ...
                      isAdmin ? (
                        <a
                          ...
                          className={`${
                            darkMode
                              ? 'hover:text-[#10aade] hover:no-underline'
                              : 'hover:no-underline hover:text-[#10aade] '
                          }`}
                        >
                          Dashboard
                        </a>
            ...
            <NavLink
              className={({ isActive }) =>
                isActive
                  ? `${
                      darkMode
                        ? 'text-white lg:inline-block xl:inline-block xxl:inline-block md:hidden hidden '
                        : 'text-red lg:inline-block xl:inline-block xxl:inline-block md:hidden hidden '
                    }`
                  : 'no-underline lg:inline-block xl:inline-block xxl:inline-block md:hidden hidden'
              }
              to="/addToCart"
            >
              <div className="flex ">
                ...
                <span
                  className={
                    darkMode
                      ? 'indicator-item badge  bg-white text-black mt-[5px] lg:inline xl:inline xxl:inline md:inline hidden'
                      : 'indicator-item badge  bg-red text-white mt-[5px] lg:inline xl:inline xxl:inline md:inline hidden'
                  }
                >
                  {addToCartData ? addToCartData.length : 0}
                </span>
