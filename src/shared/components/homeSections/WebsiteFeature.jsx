...
const WebsiteFeature = () => {
  ...
  return (
    <div
      className={`${
        darkMode
          ? " bg-gray grid grid-cols-2 gap-4 md:grid-cols-4 place-items-center w-4/5 mx-auto my-10 p-5 space-y-5"
          : "grid grid-cols-2 gap-4 md:grid-cols-4 place-items-center w-4/5 mx-auto my-10 p-5 space-y-5"
      }`}
    >
