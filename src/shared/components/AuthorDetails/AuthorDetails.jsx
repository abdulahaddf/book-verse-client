...
const AuthorDetails = () => {
  ...
  return (
    <div className="min-h-screen p-10 md:px-32 md:p-20">
      {/* Author Details  */}
      <div className={`${darkMode?"card bg-white/10  grid-cols-2 lg:card-side text-white  shadow-sm shadow-slate-100":"card grid-cols-2 lg:card-side bg-base-100 shadow-xl"}`}>
      ...
      {/* Author Book  */}
      <div className={`${darkMode?"bg-white/10 text-white shadow-sm shadow-slate-100 my-10 md:p-10 rounded-xl":"bg-base-100 shadow-xl my-10 md:p-10 rounded-xl"}`}>
      ...
      {/* YOU MAY ALSO LIKE…  */}
      <div className={`${darkMode?" bg-black/0 text-white  shadow-sm  shadow-slate-100 my-10 md:p-10 rounded-xl":"bg-gradient-to-r from-teal-50 via-base-100 to-base-100 bg-opacity-90 shadow-xl my-10 md:p-10 rounded-xl"}`}>
