      ...
      {user && singleUser && userinfo && (
        <div className="drawer lg:drawer-open">
          ...
          <div className="drawer-content w-11/12 md:w-full  flex flex-col items-center justify-center">
            ...
            <div className={darkMode?"bg-white/10 text-white absolute flex gap-5 items-center top-2 right-3 border-[1px] rounded-xl shadow-md p-3 ":"  text-white absolute flex gap-5 items-center top-2 right-3 border-[1px] rounded-xl shadow-md p-3"}>
            <div >
              <button>
