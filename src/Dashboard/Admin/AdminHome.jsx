    ...
    <div className="w-full h-full ps-4 lg:p-4 md:mt-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-6 mt-10">
        <div className="w-full md:w-1/2 grid grid-cols-1 md:grid-cols-2 gap-6 ">
          <div className={darkMode?"w-full h-full shadow-xl p-5 rounded-md bg-white/10 border-[1px]":"w-full h-full shadow-xl p-5 rounded-md bg-slate-100"}>
        ...
        <div className={darkMode?"w-full md:w-1/2 bg-white/10 border-[1px] text-black shadow-xl p-5 rounded-md ":"w-full md:w-1/2 bg-slate-100 shadow-xl p-5 rounded-md "}>
          <div style={{ width: "100%", height: 330 }}>
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <XAxis dataKey="day" stroke={darkMode?"#ffffff":"#575757"} scale="band" />
                ...
                />
                <Bar dataKey="weekly" barSize={18} fill={darkMode?"#10aade" :"#413ea0" }/>
                <Line type="monotone" dataKey="weekly" stroke={darkMode?"#ffffff":"#ff7300"} />
              </ComposedChart>
            </ResponsiveContainer>
          </div>
        </div>
      ...
      <button
        ...
        className={darkMode?"btn rounded-sm bg-black/90 ml-2 text-[#10aade] hover:text-black":"btn rounded-sm bg-[#126e9d] ml-2 text-white hover:text-black"}
      >
        <FaSearch></FaSearch>
      </button>
      ...
      <div className="flex flex-col md:flex-row justify-between gap-6 mt-6">
        <div className="w-full overflow-x-auto rounded-md shadow-xl">
          <table className="table table-zebra w-full text-center">
            ...
            <tbody className={darkMode?"bg-black divide-y divide-gray-200":"bg-slate-100 divide-y divide-gray-200"}>
              {paymentHistory
                .slice(
                  0,
