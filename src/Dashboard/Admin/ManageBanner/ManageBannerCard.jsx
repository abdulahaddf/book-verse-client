...
console.log(data)
  ...
  const handleDelete = (_id) => {
    ...
    // axios.delete(`http://localhost:5000/banner/${_id}`)
    //   .then((res) => {
    //     if (res.data.modifiedCount>0) {
    //       {
    //         Swal.fire({
    ...
    return (
      <div className="card card-compact w-96 h-72 bg-base-100 shadow-xl">
        <figure><img src={bannerURL} alt="Shoes" /></figure>
      ...
      <div className="card-body">
          ...
          <button className="primary-button" onClick={()=>document.getElementById('my_modal_2').showModal()}><FaEdit className='text-xl'></FaEdit></button>
<dialog id="my_modal_2" className="modal">
  <div className="modal-box">
    <form method="dialog" onSubmit={handleSubmit(handleEdit)}>
      
    <h3 className="text-3xl font-semibold text-center text-red uppercase">Edit Banner </h3>
...
<button className="primary-button" onClick={handleDelete}><MdDelete className='text-xl'></MdDelete></button>
</div>
                 </div>
