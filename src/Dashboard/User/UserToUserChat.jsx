      ...
      <div className="flex-1 sm:p-6 lg:px-32 justify-between flex flex-col h-[500px]  md:h-[600px] lg:h-[750px] w-full">
        ...
        <div className="flex flex-col">
          <div
            ...
            id="messages"
            className="flex flex-col space-y-4 p-3 overflow-y-auto scrollbar-thumb-blue scrollbar-thumb-rounded scrollbar-track-blue-lighter scrollbar-w-2 scrolling-touch max-h-[400px] sm:max-h-[500px]"
          >
