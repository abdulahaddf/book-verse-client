                        ...
                        <div className={darkMode?"my-2 p-[5px] py-[15px]     space-y-3 overflow-hidden   rounded-md   hover:bg-white/10  flex  ":"my-2 p-[5px] py-[15px]  bg-gray-50  space-y-3 overflow-hidden rounded-md hover:rounded-xl  border-b-[5px]  border-r-[2px] hover:bg-gray-200 flex "}>
                            ...
                            <section className="w-[60%] md:w-[70%] lg:w-[70%] pl-[15px] md:pl-0 lg:p-0 space-y-1
                             text-start">
                                {uniqueUsersData.map((userData) => {
                                    ...
                                    if (userData?.email === otherUserEmail) {
                                        return (
                                            <p key={userData?.email} className={darkMode?"text-[17px]    font-[500]  text-white":"text-[17px]    font-[500]  text-gray-600"}>
                                ...
                                {
                                    a?.chat[a?.chat.length - 1].email === user?.email && <p className={darkMode?"text-[15px] font-[400] text-white":"text-[15px] font-[400] text-gray-600"}>
                                        Your reply: {a?.chat[a?.chat.length - 1]?.text.slice(0, 27)}
                                    </p>
                                }
                                {
                                    a?.chat[a?.chat.length - 1].email !== user?.email && <p className={darkMode?" text-[15px]  font-[600] text-white":" text-[15px]  font-[600] text-gray-600"}>
                            ...
                            <section>
                                {a?.chat && a?.chat?.length > 0 && (
                                    <p className={darkMode?"text-[12px] font-[500] text-white pt-[25px]":"text-[12px] font-[500] text-gray-500 pt-[25px]"}>
